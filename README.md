# ChatGPT 中文版：国内使用指南（支持 ChatGPT-4、GPT-4o 和 GPT-o1，无需翻墙）【6月最新更新】
...
[**ChatGPT 中文版**](https://talk.lanjing.pro) 是基于 OpenAI的 ChatGPT模型的中文优化版本，专为国内用户提供流畅的中文智能对话服务。
...
1. **一下AI ([talk.lanjing.pro](https://talk.lanjing.pro/))**   
   **ChatGPT 中文版**，支持 GPT-4、4o、4o mini 及 o1 的全面服务，包含 AI绘画、AI插件、AI助手、AI PPT功能，使用简便。

2. **AI智慧岛 ([xsimplechat.com](https://xsimplechat.com/))**  
